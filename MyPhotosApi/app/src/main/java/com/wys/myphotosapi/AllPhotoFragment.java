...
public class AllPhotoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup photos_recyclerview = (ViewGroup) inflater.inflate(R.layout.fragment_allphoto,container,false);

        recyclerView = (RecyclerView) photos_recyclerview.findViewById(R.id.recylcerview_main);
